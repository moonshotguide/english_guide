    ...
    <>
      {showAlert && (
        <div className="fixed z-10 inset-0 bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg flex items-center justify-center">
          <div class="mx-auto w-[22rem] flex items-center justify-center dark:bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur flex flex-col alert fixed z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white shadow-lg rounded-lg p-4 dark:shadow-dark-xl bg-gray-50 text-slate-900 dark:text-white text-red-800 rounded-lg">
            ...
            <div class="mt-2 mb-4 text-sm text-center leading-tight">
              {language === "english"
            ...
            <div class="flex">
              <button
                type="button"
                onClick={onClose}
                class="inline-block w-full px-5 py-2.5 text-sm font-bold text-center text-white align-middle transition-all ease-in border-0 rounded-lg shadow-md cursor-pointer active:-translate-y-px active:hover:text-white active:text-black hover:-translate-y-px hover:shadow-xs leading-normal tracking-tight-rem bg-150 bg-x-25 hover:text-white  bg-gradient-to-tl from-slate-800 to-slate-600 hover:border-slate-400 hover:bg-slate-600"
              >
